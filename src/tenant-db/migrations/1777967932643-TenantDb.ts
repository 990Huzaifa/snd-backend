...
export class TenantDb1777967932643 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "scheme_products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "schemeId" uuid, "productId" uuid, CONSTRAINT "PK_71ddcce79f09ad71436fce13fb4" PRIMARY KEY ("id"))`);
