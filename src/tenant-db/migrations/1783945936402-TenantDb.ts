...
export class TenantDb1783945936402 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "stock_movements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "distributorId" uuid NOT NULL, "productId" uuid NOT NULL, "productFlavourId" integer NOT NULL, "uomId" uuid NOT NULL, "quantity" integer NOT NULL, "type" "public"."stock_movements_type_enum" NOT NULL, "referenceType" "public"."stock_movements_referencetype_enum" NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_57a26b190618550d8e65fb860e7" PRIMARY KEY ("id"))`);
