...
export class TenantDb1781689403603 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "load_sheet_orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "loadSheetId" uuid NOT NULL, "saleOrderId" uuid NOT NULL, "retailerId" uuid NOT NULL, "salesmanId" uuid NOT NULL, "deliveryStatus" "public"."load_sheet_orders_deliverystatus_enum" NOT NULL DEFAULT 'PENDING', "deliverySequence" integer NOT NULL DEFAULT '1', "customerSignature" character varying, "deliveryProof" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d9906ec51c6f4ff18ad221a1458" PRIMARY KEY ("id"))`);
